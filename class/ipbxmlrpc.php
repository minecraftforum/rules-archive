 ...
 * Last Updated: $Date: 2010-07-22 04:20:19 -0400 (Thu, 22 Jul 2010) $
 * </pre>
 *
 * @author 		$Author: matt $
...
class ipbxmlrpc
{
	 ...
	 * @return	string		finished document
	 */
	private function _buildDocumentRecurse( $xmldata, $k, $v, $depth=4 )
	{
		$xmldata .= "\t<member>\n";
		$xmldata .= "\t\t<name>".$k."</name>\n";
		$xmldata .= "\t\t<value>\n";
	...
	public function post( $file_location, $xmldata='' )
	{
		...
		else
		{
			...
			$header .= "User-Agent: IPS XML-RPC Client Library (\$Revision: 440 $)\r\n";
			$header .= "Host: $host\r\n";
...
class xmlRpcParser
{
	 ...
	 * @return	void
	 */
	private function _rpcOpen($parser, $tag, $attributes)
	{
		//-----------------------------------------
		// INIT
		//-----------------------------------------
	 ...
	 */
	private function _arrayUnshiftReference(&$array, &$value)
	{
	 ...
	 * @return	void
	 */
	private function _rpcData($parser, $data)
	{
	 ...
	 * @return	void
	 */
	private function _rpcClose($parser, $tag)
	{
